...
export default function Footer() {
  return (
    <>
      <footer className="bg-gray-900 text-gray-300 font-sans pt-16 pb-8 border-t border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                The go-to platform for affordable, accessible, and verified housing solutions across Ghana. Finding your next home made easy.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/search?type=SALE" className="hover:text-emerald-400 transition-colors">
                    Buy Properties
                  </Link>
                </li>
                <li>
                  <Link href="/search?type=RENT" className="hover:text-emerald-400 transition-colors">
                    Rent Properties
                  </Link>
                </li>
                <li>
                  <Link href="/new-homes" className="hover:text-emerald-400 transition-colors">
                    New Developments
                  </Link>
                </li>
                <li>
                  <Link href="/search?type=SALE&propertyType=LAND" className="hover:text-emerald-400 transition-colors">
                    Land listings
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a href="#" className="hover:text-emerald-400 transition-colors text-gray-400">
              ...
              <div className="space-y-2 text-xs text-gray-400">
                <p>Phone: +233 (0) 24 123 4567</p>
                <p>Email: support@reltiva.com</p>
                <p>Accra, Ghana</p>
              </div>
            </div>
          </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center h-14 w-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 active:scale-95 group focus:outline-none"
        title="Chat with us on WhatsApp"
      >
        <span className="absolute right-16 bg-gray-900 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 shadow-xl whitespace-nowrap">
          Chat on WhatsApp
        </span>
        <svg
